                        ...
                        <div class="col-md-10 offset-md-1">
                            ...
                            <form method="post" action="artigos.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="width:100%">
                                    ...
                                    <textarea id="descricao" name="descricao" class="form-control" required> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur non orci pretium, facilisis elit. </textarea>
                                </div>
                                </div>
