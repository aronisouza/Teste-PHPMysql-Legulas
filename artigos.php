                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($artigos as $artigo):
                                        if($artigo->imagem == "") $imgPath = URL_ATUAL."/teste/teste_prog/style/img/semimg.svg";
                                        else $imgPath = $imgPath.$artigo->imagem;?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <img src="<?=$imgPath;?>" alt="<?=urldecode($artigo->titulo)?>" style="max-width:100px;height:auto;">
